 ...
 * The root layout now wraps the site in a shared multi-page shell with a rounded sidebar so search, methods, and about content can live on dedicated routes, with all shell styling expressed directly through Tailwind classes and the shell width bound to a valid Tailwind max-width token.
 */
  ...
  return (
    ...
    >
      <body className="min-h-full bg-[#111111] text-neutral-100">
        <div className="mx-auto min-h-screen max-w-[1600px] px-3 py-3 sm:px-4 lg:px-5">
